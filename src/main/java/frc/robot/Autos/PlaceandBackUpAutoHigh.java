...
public class PlaceandBackUpAutoHigh extends SequentialCommandGroup {
    


    public  PlaceandBackUpAutoHigh(Swerve s_Swerve, ArmSubsystem s_Arm, HandSubsystem s_Hand, ExtendingSubsystem s_Extend,
    HopperSubsystem s_Hopper, PistonSubsystem s_Piston){
    // Path Planner Path
    String robot_path = "PlaceAndBackUpHigh";
